---
title: "Hands-On/In Class Exercise 4: Geographically Weighted Regression (Chapter 6)"
editor: visual
---

> Update: included some notes added in class
...
> Note: condo_resale is used below, not using condo_resale.sf because it contains geometric/spatial fields
...
> R\^2: Account for 65% of variation
>
> Interpretation using signs and magnitude of the coefficients beta column
...
The result shows that the recommended bandwidth is 971.3398 meters. (Quiz: Do you know why it is in metre?)
...
> Compare the AICc for models and the smaller one is the 'better' model. In this case, the AICc of GWR is lower
...
| Zoom limits sets a min and max zoom allowed for the plot
...
> sync = TRUE allows for the same interaction between both maps side by side
