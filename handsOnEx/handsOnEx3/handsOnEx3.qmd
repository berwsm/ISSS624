---
title: "Hands-on/In-Class Exercise 3: Geographical Segmentation with Spatially Constrained Clustering Techniques (Chapter 5)"
editor: visual
---

> Update:
>
> Added sections on ClustGeo and Visual Interpretation
>
> Included some notes added in class
...
The code chunks below is used to perform the task. The unique identifier used to join both data objects is *TS_PCODE*. The sequence retains the geometric properties.
...
> Skater method is 'hard' controlled by spanning tree while ClustGeo is 'soft' because homogeneity but still have because of the attribute.
